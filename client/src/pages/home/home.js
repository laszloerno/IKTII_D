      ...
      <div className={'content-block'}>
        <div className={'dx-card responsive-paddings'}>
          ...
          <div className={'content'}>
            <h3>Önálló Web-es feladat</h3>
            <p>
              A meglévő keretrendszerbe mindenki varázsoljon bele egy adatbázis
              kapcsolaton keresztül töltött táblát. A tábla töltése bármilye
              módon történhet
            </p>
            <p>
              <ol>
                <li>Egy adatbázis táblát használj!</li>
                <li>A tábla tartalmazzon legalább 6 mezőt</li>
                <li>
                  modelben történő kapcsolódás - sequlize (auth/user.js
                  segítség)
                </li>
                <li>
                  API endpoint készítése POST, GET, DELETE (routes/tabla.js
                  segítség)
                </li>
                <li>Frontend oldalon egy új page beillesztése</li>
                <li>Az oldalon a tábla megjelenítése Grid segítségéve</li>
                <li>Új rekord felvitele, törlése</li>
                <li>Adatok módosítása</li>
              </ol>
            </p>
            <p>
              Feel free to explore this template and change its layout to meet
              your needs.
            </p>
          </div>
